...
# def test_init():
#     proj_gd = ProjectedGD(
#         data=torch.zeros((2,2)), lr=1e-3, max_iter=1000, tol=1e-3, verbose=False)
...
#     proj_gd = ProjectedGD(
#         data=singleview_pca.data_arr.clone(),
#         proj_params={"pca_singleview": singleview_pca},
#         lr=None, max_iter=100, tol=1e-3, verbose=True
#     )
